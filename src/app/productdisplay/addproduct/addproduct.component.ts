...
export class AddproductComponent implements OnInit {
  ...
  onProductAdd()
  {
    ...
    this._ser.addProduct(new Product(this.pro_id,this.pro_name,this.pro_color,this.pro_price,this.pro_qty,this.pro_mfg,this.pro_img,this.pro_info,this.selected)).subscribe(
      (data:Product[])=>{
        console.log(data);
